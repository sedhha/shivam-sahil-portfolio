    ...
    components: [
...

      {
        ...
        front: {
          isWebImage: true,
          imgSource:
            'https://github.com/sedhha/gitpractice/blob/master/webpf/web/images/projects/covifitness.jpg',
          display: 'front',
...

      {
        ...
        front: {
          isWebImage: true,
          imgSource:
            'https://github.com/sedhha/gitpractice/blob/master/webpf/web/images/projects/geecorn.png',
          display: 'front',
          disableGradientForPhoto: true,
          gradientColor1: colors.color_white,
          gradientColor2: colors.color_white,
...

      {
        ...
        front: {
          isWebImage: true,
          imgSource:
            'https://github.com/sedhha/gitpractice/blob/master/webpf/web/images/projects/kratosrover.png',
          display: 'front',
          disableGradientForPhoto: true,
          gradientColor1: colors.color_white,
          gradientColor2: colors.color_white,
